...
Opcode = namedtuple("Opcode", (
        ...
        "flags_affected"))          # tuple of zero or more Flags constants
...
Opcodes = (
    ...
    Opcode(number=0x02,
           ...
           addr_mode=AddressModes.Inherent,
           flow_type=FlowTypes.Continue,
           flags_affected=(Flags.N, Flags.Z, Flags.C)),
    Opcode(number=0x03,
    ...
    Opcode(number=0x04,
           ...
           flow_type=FlowTypes.Continue,
           flags_affected=(Flags.N, Flags.Z)),
    Opcode(number=0x05,
    ...
    Opcode(number=0x12,
           ...
           addr_mode=AddressModes.Inherent,
           flow_type=FlowTypes.Continue,
           flags_affected=(Flags.N, Flags.Z, Flags.V, Flags.C)),
    Opcode(number=0x13,
    ...
    Opcode(number=0x62,
           ...
           addr_mode=AddressModes.Inherent,
           flow_type=FlowTypes.Continue,
           flags_affected=(Flags.N, Flags.Z, Flags.V)),
    Opcode(number=0x63,
    ...
    Opcode(number=0x85,
          ...
          flow_type=FlowTypes.Continue, flags_affected=()),
    Opcode(number=0x86,
