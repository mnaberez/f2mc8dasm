...
Opcodes = {
    ...
    0x68: ("and a, r0",           AddressModes.Register,      FlowTypes.Continue),
    0x69: ("and a, r1",           AddressModes.Register,      FlowTypes.Continue),
    0x6a: ("and a, r2",           AddressModes.Register,      FlowTypes.Continue),
    0x6b: ("and a, r3",           AddressModes.Register,      FlowTypes.Continue),
    0x6c: ("and a, r4",           AddressModes.Register,      FlowTypes.Continue),
    0x6d: ("and a, r5",           AddressModes.Register,      FlowTypes.Continue),
    0x6e: ("and a, r6",           AddressModes.Register,      FlowTypes.Continue),
    0x6f: ("and a, r7",           AddressModes.Register,      FlowTypes.Continue),
    ...
    0xf8: ("bnc REL",             AddressModes.Relative,    FlowTypes.ConditionalBranch),
    0xf9: ("bc REL",              AddressModes.Relative,    FlowTypes.ConditionalBranch),
